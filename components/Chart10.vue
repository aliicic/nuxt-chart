<template>
  <div>
    <p style="text-align: center">  پنج نفر اول مخاطبان تسک های من</p>
    <client-only>
      <ApexCharts
        :options="options"
        :series="series"
...
export default {
  ...
  async fetch() {
    const {
      ...
      "https://ws.datisint.com/api/v2/staff/report/getReport/33?user_id=1077&start_date=0&end_date=1857617000&type=creator",
      {
        headers: {
          Authorization:
